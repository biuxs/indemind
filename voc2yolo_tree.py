...
if __name__ == "__main__":
    ...
    # classes = ['shoes', 'bin', 'pedestal', 'wire', 'socket','cat','dog','desk_rect','desk_circle','weighing-scale', 'key', 'person','chair', 'couch', 'bed', 'tvCabinet', 'fridge', 'television', 'washingMachine', 'electricFan', 'remoteControl', 'shoeCabinet']
    classes = ['down']
    # classes_new = ['10+','dog']
    classes_new = []
    ...
    rootPath = '/mnt/20251028_fall/python_shixi_task/yoloServer/data/raw'
    ...
    xml_list = read_xml_list('/mnt/20251028_fall/python_shixi_task/yoloServer/data/raw/all.txt')
